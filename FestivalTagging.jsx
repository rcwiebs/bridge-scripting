...
function displayDialog() {
    ...
    // GROUP1
    // ======
    var group1 = FestPalette.add("group", undefined, {name: "group1"}); 
    ...
    var myText = group1.add("group"); 
        ...
        myText.add("statictext", undefined, "1. Move all images to a single folder to your computer.\r2. Open the folder in Bridge.\r3. Select all the images (Edit > Select All). Only\r    the image files will be processed.\r4. Click the Run Script button.", {multiline: true}); 
    // GROUP2
    // ======
    var group2 = FestPalette.add("group", undefined, {name: "group2"}); 
